...
/** Test driver class to test the CardHolder, LendingItem
...
public class LendingFacilityTestDriver
{
  public static void main(String[] args)
  {
    ...
    CardHolder testMember = new CardHolder("Test",
                                           1,
                                          "455-1111");
    ...
    String[] testItemDescription = {"Take Care - Drake - CD",
                                    "21 - Adele - CD",
    ...
    { if(tommy.signOut(testItemList[i]))
      { tommysItem = testItemList[i];        // Remember this for Test case #10
        if (testItemList[i].isRestricted())
          ...
          System.out.println("Correct result: Tommy was able to sign out an unrestricted item.");
      }
      else
      { if (testItemList[i].isRestricted())
          System.out.println("Correct result: Tommy was prevented from signing out a restricted item.");
        else
          System.out.println(">> ERROR: Tommy was prevented from signing out an unrestricted item.");
      }
    }
    ...
    if(sally.returnItem(testItemList[3]))
      System.out.println("Correct result: Susan Boyle was successfully returned.");
    else
      System.out.println(">> ERROR: Susan Boyle was not successfully returned.");
